...
cover_image: "https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/santa_augmentcode_intent_series/santa-augmentcode-intent-episode-01.png"
canonical_url: ""
...
[Augment Intent](https://www.augmentcode.com/product/intent) is a **macOS developer workspace** designed for the age of AI agents. It is not merely a chat window where you ask a single Elf to do one thing. It is a **coordinated workshop** where:
...
Intent is currently in **public beta for macOS**. You can [download it here](https://www.augmentcode.com/product/intent). It works with your existing Augment credits, and you can even bring Claude Code, Codex, or OpenCode if you already have a subscription for those.

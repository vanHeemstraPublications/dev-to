...
cover_image: "https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-01.png"
...
2. Click **New Project**
3. Choose your board: **Arduino UNO R3** (perfect for our first test)
4. In the AI chat panel, type exactly this:
...
2. Click **Upload**
3. Chrome asks permission to access the serial port — click Allow
4. Codey auto-detects the board, resets it, and flashes the firmware

...
Series Name: Card Deck Expo Series
Series Type: expo_react_native_series
...
Defaults
setting: elegant close-up card table and small theatre stage
lighting: dramatic spotlight with warm velvet-club ambience

Composition
left third: card magician or presenter explaining the move
center: the featured deck metaphor or app-building action
right third: assistant, props table, or audience reaction
background: velvet curtains, felt table, and performance stage

Episode Metaphor
different hands and suits organize the deck into meaningful groups you can move through quickly

Center Action
dealing cards into neat hands and grouped suits for navigation
...
Local Image Path
images/card_deck_expo_series/episode-05.webp
...
Scene setting:
elegant close-up card table and small theatre stage

Lighting and atmosphere:
dramatic spotlight with warm velvet-club ambience
...
stacked hands, suit markers, navigation mat

Style requirements:
- cinematic digital illustration, richly detailed, elegant card-table realism, polished mobile-app tutorial composition
...
Series type:
expo_react_native_series

Episode:
Episode 5: Suits and Hands (Stacks, Tabs & Navigation Layouts)

Writing style requirements:
- tone: playful, practical, and beginner-friendly
- humor style: sleight-of-hand card metaphors with crisp developer humor
- beginner-friendly
- explain complex concepts in simple terms
- include code samples in Markdown with TypeScript, TSX, JSON, and shell examples where helpful

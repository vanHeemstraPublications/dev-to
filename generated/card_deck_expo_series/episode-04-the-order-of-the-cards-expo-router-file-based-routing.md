...
Episode Metaphor
the power of a trick depends on the exact order in which the cards are arranged

Center Action
sorting cards into a precise sequence that controls the whole routine
...
Local Image Path
images/card_deck_expo_series/episode-04.webp
...
ordered deck, route map, index cards

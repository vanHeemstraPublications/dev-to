...
Series Name: Like LEGO? Love Python!
Series Type: python_learning_series
...
Composition
left third: master builder or guide explaining the concept
center: the featured brick-building action that embodies the Python topic
right third: finished models, instruction pieces, or supporting builds
background: shelves of bricks, instruction manuals, and a tidy workshop bench

Episode Metaphor
encapsulation is like hiding a brick's internal structure while keeping the useful connectors exposed

Center Action
locking away the inner mechanics of a special brick while keeping its surface simple

Supporting Props
- sealed compartment
- protected brick core
- builder gloves


Local Image Path
images/like_lego_love_python_series/episode-02.webp
...
Scene setting:
bright creative brick workshop and build table

Lighting and atmosphere:
clean playful studio light with colorful reflections
...
sealed compartment, protected brick core, builder gloves

Style requirements:
- cinematic digital illustration, highly detailed, colorful toy-workshop realism, polished educational composition
...
- tone: friendly, playful, and beginner-friendly
- humor style: toy-brick metaphors with warm, clever teaching humor
- beginner-friendly

...
Episode Metaphor
polymorphism is one building instruction working across many different brick types

Center Action
demonstrating one action that works across multiple brick shapes

Supporting Props
- mixed brick set
- shared instruction sheet
- demo model


Local Image Path
images/like_lego_love_python_series/episode-04.webp
...
mixed brick set, shared instruction sheet, demo model

...
Slug: let-the-wookiee-win-r2-moves
...
Episode Metaphor
the dome-bot finally moving with a rotating dome and motorised wheels driven by an L298N H-bridge

Center Action
the dome-bot's dome sweeps under SG90 servo control while DC gear motors roll it across the workbench

Supporting Props
- SG90 micro servo
- L298N motor driver
- DC gear motors with wheels
- 74AHCT125 level shifter and separate battery pack


Local Image Path
images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-06.png

Public Cover Image URL
https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-06.png
...
SG90 micro servo, L298N motor driver, DC gear motors with wheels, 74AHCT125 level shifter and separate battery pack

...
Series ID: r2-d2_creation_with_codey_series
Series Name: Dome-Bot Build with Codey
Series Type: maker_dome_bot_build_series

Episode: 2 - Finding Its Voice
Slug: the-sound-of-the-force
...
Defaults
setting: a friendly retro sci-fi maker workshop where a half-built dome-bot is wired up alongside an Arduino/ESP32 development bench, a laptop running Codey Online in the browser, and tidy breadboard layouts
lighting: warm workbench lighting with cool blue-white dome-LED glow, soft holographic accents, and gentle cinematic rim light evoking a retro sci-fi maker workshop
...
Episode Metaphor
the dome-bot finds its signature beep-and-whistle voice through a piezo buzzer and Arduino's tone() function

Center Action
a passive piezo buzzer plays the dome-bot's first beep-and-whistle sequence driven by the Arduino UNO

Supporting Props
- passive piezo buzzer
- 100 ohm resistor
- Codey Smart Library Picker panel
- wiring diagram with pin 8 highlighted


Local Image Path
images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-02.png

Public Cover Image URL
https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-02.png
...
Scene setting:
a friendly retro sci-fi maker workshop where a half-built dome-bot is wired up alongside an Arduino/ESP32 development bench, a laptop running Codey Online in the browser, and tidy breadboard layouts

Lighting and atmosphere:
warm workbench lighting with cool blue-white dome-LED glow, soft holographic accents, and gentle cinematic rim light evoking a retro sci-fi maker workshop
...
passive piezo buzzer, 100 ohm resistor, Codey Smart Library Picker panel, wiring diagram with pin 8 highlighted

...
Episode: 5 - The Holo Projector
Slug: the-projector-of-hope
...
Episode Metaphor
the dome-bot receiving a new brain and a holo projector through an ESP32-S3 upgrade and an OLED display

Center Action
the maker swaps the Arduino UNO for an ESP32-S3 N16R8 and a 128x64 SSD1306 OLED projects a small holographic message

Supporting Props
- ESP32-S3 N16R8 board
- SSD1306 OLED display
- I2C wiring sketch
- Codey Milestones and Rollback panel


Local Image Path
images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-05.png

Public Cover Image URL
https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-05.png
...
ESP32-S3 N16R8 board, SSD1306 OLED display, I2C wiring sketch, Codey Milestones and Rollback panel

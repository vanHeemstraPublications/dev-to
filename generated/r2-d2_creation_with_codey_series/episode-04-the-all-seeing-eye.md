...
Episode Metaphor
the dome-bot gaining perception through an ultrasonic sensor eye and a PIR motion detector

Center Action
the dome-bot's HC-SR04 sensor lights up as an approaching hand triggers the dome to react and a beep to play

Supporting Props
- HC-SR04 ultrasonic sensor
- HC-SR501 PIR motion sensor
- Codey Auto Error Fixing panel
- breadboard photo for Vision check


Local Image Path
images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-04.png

Public Cover Image URL
https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-04.png
...
HC-SR04 ultrasonic sensor, HC-SR501 PIR motion sensor, Codey Auto Error Fixing panel, breadboard photo for Vision check

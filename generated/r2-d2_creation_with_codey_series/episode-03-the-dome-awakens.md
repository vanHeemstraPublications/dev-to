...
Episode: 3 - The Dome Lights Up
Slug: the-dome-awakens
...
Episode Metaphor
the dome-bot's signature dome coming alive with a ring of blue-and-white NeoPixel light

Center Action
a 12-LED WS2812B NeoPixel ring lights up the dome-bot's dome in pulsing blue-white animations

Supporting Props
- NeoPixel ring
- 470 ohm resistor
- 100 microfarad capacitor
- voltage safety check warning card


Local Image Path
images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-03.png

Public Cover Image URL
https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/r2-d2_creation_with_codey_series/r2-d2-creation-with-codey-episode-03.png
...
NeoPixel ring, 470 ohm resistor, 100 microfarad capacitor, voltage safety check warning card

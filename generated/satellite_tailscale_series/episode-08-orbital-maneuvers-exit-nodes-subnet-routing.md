...
Series Name: Satellite Tailscale Series
Series Type: networking_series
...
Defaults
setting: retro-futuristic mission control and orbital operations room
lighting: cool cinematic starlight with glowing control panels

Composition
left third: mission commander or guide at the console
center: the featured satellite-network action
right third: ground station, device, or supporting operator
background: Earth, starfield, radar screens, and orbital diagrams

Episode Metaphor
orbital transfers and route relays move traffic through the best path across the constellation

Center Action
redirecting network traffic through relay satellites and planned orbital routes
...
Local Image Path
images/satellite_tailscale_series/episode-08.webp
...
Scene setting:
retro-futuristic mission control and orbital operations room

Lighting and atmosphere:
cool cinematic starlight with glowing control panels
...
maneuver chart, relay node, route arrows

Style requirements:
- cinematic digital illustration, highly detailed, retro-futuristic space-mission realism, polished networking explainer composition
...
- tone: curious, confident, and beginner-friendly
- humor style: space-mission metaphors with light systems-engineering humor
- beginner-friendly
- explain complex concepts in simple terms
- include code samples in Markdown with shell, YAML, and networking examples where helpful

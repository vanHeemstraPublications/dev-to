...
Episode Metaphor
after the room is built, each zone, device, and routine must be moved into its proper place

Center Action
mapping the home into rooms and plugging in the first devices
...
Local Image Path
images/panic_room_home_assistant_series/episode-04.webp
...
floor plan, room labels, integration icons
...
---
title: "Panic Room Home Assistant Ep.4"
published: false

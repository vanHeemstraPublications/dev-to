...
Series Name: Panic Room Home Assistant Series
Series Type: home_automation_series
...
Defaults
setting: secure modern home and panic room control center
lighting: calm cinematic interior light with dashboard glow

Composition
left third: homeowner or integrator explaining the setup
center: the featured room, device, or automation action
right third: supporting sensors, tablets, or security hardware
background: floor plans, smart-home dashboards, and reinforced walls

Episode Metaphor
the protected room is built inside a controlled environment before the rest of the system moves in

Center Action
assembling the core control room inside a contained virtual space
...
Local Image Path
images/panic_room_home_assistant_series/episode-03.webp
...
Scene setting:
secure modern home and panic room control center

Lighting and atmosphere:
calm cinematic interior light with dashboard glow
...
virtual machine console, construction blueprint, control rack

Style requirements:
- cinematic digital illustration, highly detailed, secure smart-home realism, polished home-automation explainer composition
...
Series type:
home_automation_series

Episode:
Episode 3: Building the Panic Room (Installing HAOS in Parallels)

Writing style requirements:
- tone: calm, practical, security-minded, and beginner-friendly
- humor style: home-security metaphors with dry, reassuring wit
- beginner-friendly
- explain complex concepts in simple terms
- include code samples in Markdown with YAML, shell, and configuration examples where helpful
...
---
title: "Panic Room Home Assistant Ep.3"
published: false

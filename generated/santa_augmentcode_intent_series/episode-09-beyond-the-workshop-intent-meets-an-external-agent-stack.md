...
Episode Metaphor
the North Pole workshop extending its discipline into a field-ready travelling command kit

Center Action
Santa shows how Claude Code, the Augment Context Engine MCP, RTK, and LiteLLM can work together beyond Intent itself

Supporting Props
- travelling tool chest
- Mac Mini console
- routing gateway lantern
- compressed shell transcript


Local Image Path
images/santa_augmentcode_intent_series/santa-augmentcode-intent-episode-09.webp
...
travelling tool chest, Mac Mini console, routing gateway lantern, compressed shell transcript
...
- include code samples in Markdown with shell, YAML, and JSON snippets where helpful
...
4. include concrete examples or snippets where helpful

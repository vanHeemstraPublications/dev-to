...
Episode Metaphor
every elf has a separate workbench so tools and tasks never collide

Center Action
parallel elves work at isolated benches connected to the same shared workshop knowledge

Supporting Props
- separate workbenches
- git worktree signposts
- tool chests
- branch labels


Local Image Path
images/santa_augmentcode_intent_series/santa-augmentcode-intent-episode-04.webp
...
separate workbenches, git worktree signposts, tool chests, branch labels

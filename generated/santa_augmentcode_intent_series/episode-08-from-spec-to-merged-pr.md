...
Episode Metaphor
a full Christmas delivery run from wish list to gifts safely under the tree

Center Action
the team moves from prompt and spec to verified changes, approval, and a merged pull request

Supporting Props
- pull request ribbon
- review checklist
- merged stamp
- sleigh delivery ledger


Local Image Path
images/santa_augmentcode_intent_series/santa-augmentcode-intent-episode-08.webp
...
pull request ribbon, review checklist, merged stamp, sleigh delivery ledger

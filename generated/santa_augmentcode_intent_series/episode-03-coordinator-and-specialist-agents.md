...
Episode Metaphor
Santa coordinating specialists like a well-run Christmas delivery operation

Center Action
Santa plans tasks while specialist elves execute and a verifier checks the output
...
Local Image Path
images/santa_augmentcode_intent_series/santa-augmentcode-intent-episode-03.webp
...
assignment board, elf role badges, quality stamp, handoff envelopes

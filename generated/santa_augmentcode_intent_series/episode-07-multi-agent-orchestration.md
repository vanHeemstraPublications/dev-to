...
Episode Metaphor
waves of elves moving in parallel with precise timing and no collisions

Center Action
multiple specialist elves run in coordinated waves with clear dependencies and handoffs
...
Local Image Path
images/santa_augmentcode_intent_series/santa-augmentcode-intent-episode-07.webp
...
orchestration board, dependency strings, signal bells, queue markers

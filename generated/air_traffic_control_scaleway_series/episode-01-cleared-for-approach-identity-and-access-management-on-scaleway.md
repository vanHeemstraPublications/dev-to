...
Series Name: Air Traffic Control Scaleway Series
Series Type: cloud_platform_explainer_series
...
Defaults
setting: modern airport control tower, runway network, and operations center
lighting: clear cinematic sunrise with crisp radar glow

Composition
left third: air traffic controller or guide at the tower console
center: aircraft movement that embodies the Scaleway service being explained
right third: ground crew, secondary aircraft, or service operators
background: runways, radar walls, hangars, and airport skyline

Episode Metaphor
airport control verifies pilot identity and flight plans before granting access to controlled airspace

Center Action
clearing an incoming crew through identity and access checks
...
Local Image Path
images/air_traffic_control_scaleway_series/episode-01.webp
...
Scene setting:
modern airport control tower, runway network, and operations center

Lighting and atmosphere:
clear cinematic sunrise with crisp radar glow
...
clearance desk, pilot credentials, approach radar

Style requirements:
- cinematic digital illustration, highly detailed, aviation operations realism, polished cloud-platform explainer composition
...
Series type:
cloud_platform_explainer_series

Episode:
Episode 1: Cleared for Approach: Identity and Access Management on Scaleway

Writing style requirements:
- tone: confident, accessible, operations-minded, and beginner-friendly
- humor style: aviation-flavored metaphors with light instructional wit
- beginner-friendly
- explain complex concepts in simple terms
- include code samples in Markdown with shell, YAML, JSON, and infrastructure examples where helpful
...
[UPDATE_SERIES_GITHUB_REPOSITORY_URL]
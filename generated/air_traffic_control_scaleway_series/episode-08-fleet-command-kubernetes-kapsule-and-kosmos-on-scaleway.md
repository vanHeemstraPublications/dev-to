...
Episode Metaphor
one command room orchestrates an entire fleet of aircraft across multiple formations

Center Action
coordinating many flights from a unified fleet command desk
...
Local Image Path
images/air_traffic_control_scaleway_series/episode-08.webp
...
fleet map, squadron board, orchestration console

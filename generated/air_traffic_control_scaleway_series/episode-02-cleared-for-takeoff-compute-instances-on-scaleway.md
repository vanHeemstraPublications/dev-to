...
Episode Metaphor
the tower assigns the right aircraft and runway for each mission

Center Action
dispatching the right compute aircraft for a specific workload
...
Local Image Path
images/air_traffic_control_scaleway_series/episode-02.webp
...
runway lights, aircraft hangar, departure board

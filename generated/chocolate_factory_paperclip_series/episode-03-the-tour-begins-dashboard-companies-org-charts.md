...
Series Name: Chocolate Factory Paperclip Series
Series Type: ai_company_builder_series
...
Defaults
setting: whimsical chocolate factory full of conveyor belts and invention rooms
lighting: golden storybook factory light with sparkling highlights

Composition
left third: factory guide or founder presenting the process
center: the featured factory-room metaphor and product action
right third: workers, agents, or supporting machinery
background: pipes, candy machinery, and imaginative production rooms

Episode Metaphor
the opening tour reveals the control room, company map, and the people behind the machinery

Center Action
walking through the control gallery that explains the whole factory
...
Local Image Path
images/chocolate_factory_paperclip_series/episode-03.webp
...
Scene setting:
whimsical chocolate factory full of conveyor belts and invention rooms

Lighting and atmosphere:
golden storybook factory light with sparkling highlights
...
dashboard wall, org chart board, company directory

Style requirements:
- cinematic digital illustration, highly detailed, whimsical factory realism, polished product-tour composition
...
Series type:
ai_company_builder_series

Episode:
Episode 3: The Tour Begins (Dashboard, Companies & Org Charts)

Writing style requirements:
- tone: whimsical, clear, and beginner-friendly
- humor style: Roald Dahl-inspired factory metaphors with light operational humor
- beginner-friendly
- explain complex concepts in simple terms
- include code samples in Markdown with JSON, YAML, and shell snippets where helpful
...
---
title: "Chocolate Factory Paperclip Ep.3"
published: false

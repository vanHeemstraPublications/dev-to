...
Episode Metaphor
project rules and memory giving an agent care for the codebase it touches

Center Action
WARP.md, rules, and skills transform generic automation into context-aware project behaviour
...
Local Image Path
images/wizard_of_oz_warp_series/wizard-of-oz-warp-episode-03.png

Public Cover Image URL
https://raw.githubusercontent.com/vanHeemstraPublications/dev-to/main/images/wizard_of_oz_warp_series/wizard-of-oz-warp-episode-03.png
...
tin oil can, rules scroll, repository map, memory ledger

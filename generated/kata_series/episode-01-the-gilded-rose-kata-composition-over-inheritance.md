...
Series Name: Kata Series
Series Type: refactoring_kata_series
...
Composition
left third: mentor or kata practitioner explaining the exercise
center: the core kata problem being reshaped
right third: tests, notes, or refactoring tools
background: dojo boards, laptops, and practice artifacts
...
Local Image Path
images/kata_series/episode-01.webp
...
Scene setting:
coding dojo with whiteboards, test benches, and refactoring notes

Lighting and atmosphere:
focused workshop lighting with calm study atmosphere

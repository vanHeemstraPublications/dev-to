...
Series Name: Infrastructure as Code Adventures
Series Type: infrastructure_as_code_series
...
Composition
left third: guide or engineer introducing the infrastructure metaphor
center: the featured Crossplane or cloud systems concept in action
right third: supporting tools, diagrams, or secondary system operators
background: cloud blueprints, consoles, and whimsical training props
...
Local Image Path
images/cross_plane_series/episode-03.webp
...
Scene setting:
playful cloud engineering lab with diagrams, control panels, and infrastructure props

Lighting and atmosphere:
bright cinematic workshop light with technical dashboard glow
...
---
title: "Infrastructure as Code Adventures Ep.3"
published: false
